...
def get_data(dataset, directory, img_directory):
    ...
    with open(directory+dataset) as f:
        ...
        for line in f:
            ...
            images.append(directory+img_directory+fname)
...
def getKings():
    ...
    datasource_train = get_data(dataset_train, directory, img_directory)
    datasource_test = get_data(dataset_test, directory, img_directory)
...
def getBlender():
    ...
    dataset_test = 'blender_test.txt'
    dataset_train = 'blender_train.txt'

    datasource_test = get_data(dataset_test, directory, test_directory)
    datasource_train = get_data(dataset_train, directory, train_directory)
